...
* The original package name 'com.example.aquaSphere.ShoppingCart.Shopping Cart' is invalid and this project uses 'com.example.aquaSphere.ShoppingCart.Shopping.Cart' instead.
