...
public class InventoryEntity {
    ...
    private double initialCost;  // Added new attribute for initial cost
    ...
    private double totalAmount; // Field to store calculated total amount
    private double profit; // New field to store calculated profit
    ...
    public void calculateProfit() {
        this.profit = totalAmount - initialCost; // Calculate profit as selling price minus initial cost
    }
